...
// ESP32 Marauder v6.1 S3 (ESP32-S3 SuperMini)
// GPIO19/20 = USB D-/D+ on S3 → MISO moved to GPIO15
// GPIO23 does not exist on ESP32-S3 (chip range: 0-21, 26-48) → MOSI moved to GPIO7
// GPIO32 is in the flash/PSRAM reserved range (26-32) → BL moved to GPIO47
#define TFT_MISO 15
#define TFT_MOSI  7
#define TFT_SCLK 18
...
#define TFT_BL   47  // LED back-light (GPIO47, exposed on SuperMini right-side header)
