#pragma once
 ...
 //// BOARD FEATURES
    ...
    #define HAS_NIMBLE_2
    #define HAS_IDF_3
    #define HAS_BATTERY       // MAX17048 shares I2C bus with FT6336U (SDA=9, SCL=10)
  #endif
  //// END BOARD FEATURES
  ...
  //// DISPLAY DEFINITIONS
      ...
      // Pins are in User_Setup_Pancake.h: MOSI=24, MISO=4, SCLK=23, CS=5, DC=3, RST=2
      // Backlight PWM on GPIO 26
      #define TFT_BL 26
      #define CHAN_PER_PAGE 7
      #define SCREEN_CHAR_WIDTH 40
      #define HAS_ILI9341
  ...
  //// MENU DEFINITIONS
    ...
    #define KEY_Y         60  // TOP_FIXED_AREA + KEY_H/2
  ...
  //// NEOPIXEL STUFF  
      ...
      #define PIN 27
    #elif defined(MARAUDER_PANCAKE)
      #define PIN 27   // ESP32-C5-DevKitC-1 onboard RGB LED
    #elif defined(MARAUDER_CARDPUTER_ADV)
      #define PIN 21
    #else
      #define PIN 25
